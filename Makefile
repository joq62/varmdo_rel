all:
	rm -rf  *~ */*~ apps/*/src/*.beam test/*.beam erl_cra*;
...
eunit:
	rm -rf  *~ */*~ apps/*/src/*.beam test/*.beam test_ebin erl_cra*;
...
release:
	...
	erlc -o test_ebin test/*.erl;
	erl -pa test_ebin -run release start varmdo_rel ../catalog/catalog.specs
